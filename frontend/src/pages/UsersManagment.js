    ...
    <section className="mt-8 max-w-7xl mx-auto p-4">
      ...
      <div className="flex justify-end mb-4">
        <input
          ...
          className="w-full md:w-1/3 px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-primary"
                  ...
                  {editingUser === user.id ? (
                    ...
                    <>
                      <button
                        ...
                        className="bg-secondary hover:bg-blue-700 text-black px-3 py-1 rounded transition-colors duration-300 mr-2"
                      >
                        Edit
                      </button>
                      <button
